...
const boxShow1 = document.getElementById('boxShow1')        
const clickShow1 = document.getElementById('clickShow1')        
const clickCloseShow1 = document.getElementById('clickCloseShow1')        
clickShow1.addEventListener('click', function(){
    boxShow1.style.display = 'block'
    clickCloseShow1.style.display = 'block'
    clickShow1.classList.add('open-active')
})
clickCloseShow1.addEventListener('click', function(){
    boxShow1.style.display = 'none'
    clickCloseShow1.style.display = 'none'
    clickShow1.classList.remove('open-active')
})

const boxShow2 = document.getElementById('boxShow2')        
const clickShow2 = document.getElementById('clickShow2')        
const clickCloseShow2 = document.getElementById('clickCloseShow2')        
clickShow2.addEventListener('click', function(){
    boxShow2.style.display = 'block'
    clickCloseShow2.style.display = 'block'
    clickShow2.classList.add('open-active')
})
clickCloseShow2.addEventListener('click', function(){
    boxShow2.style.display = 'none'
    clickCloseShow2.style.display = 'none'
    clickShow2.classList.remove('open-active')
})
